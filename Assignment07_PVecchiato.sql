...
-- 2022-11-28,PVecchiato,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_PVecchiato')
	 Begin 
	  Alter Database [Assignment07DB_PVecchiato] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_PVecchiato;
	 End
	Create Database Assignment07DB_PVecchiato;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_PVecchiato;
